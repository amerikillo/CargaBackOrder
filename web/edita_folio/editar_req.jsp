    ...
    <div class="container">
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <%
                ResultSet rset = null;
                obj.conectar();
                rset = obj.consulta("select * from back_solicitado where fol_bac = '" + folio + "';");
                while (rset.next()) {
            %>
            <tr>
                <td><a href="edita_reg_req.jsp?folio=<%=folio%>&registro=<%=rset.getString(1)%>"><%=rset.getString(1)%></a></td>
