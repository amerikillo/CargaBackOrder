...
<html>
    ...
    <body>
    <div class="container">
        <h1>Edita Registro de Abasto</h1>
        <a href="editar_aba.jsp?folio=<%=folio%>">Regresar</a>
        <%
            ResultSet rset = null;
            obj.conectar();
            rset = obj.consulta("select * from back_surtido where id_bac_sur= '" + registro + "';");
            while (rset.next()) {
        %>
        <form name="form_actualiza_folio" action="../Principal" method="POST">
            ...
            <table class="table table-bordered table-striped table-hover">
              ...
              <tr>
                ...
                <td><input type="text" name="tabla" value="back_surtido" readonly /></td>
              </tr>
              <tr>
                <th scope="row">Clave: </th>
                <td><input type="text" name="clave" value="<%=rset.getString(3)%>" readonly /></td>
              </tr>
              <tr>
                <th scope="row">Cantidad: </th>
                <td><input type="text" name="cantidad" value="<%=rset.getString(4)%>" /></td>
              </tr>
              <tr>
                <th scope="row">&nbsp;</th>
                <td><input type="submit" value="Actualizar Registro de Abasto" name="submit" class="btn btn-primary" /></td>
              </tr>
            </table>
            <p>&nbsp;</p>
        </form>
